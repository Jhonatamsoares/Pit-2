package com.cs5500.Delivery.controller;

import com.cs5500.Delivery.exception.OrderAlreadyDeliverException;
import com.cs5500.Delivery.exception.OrderAlreadyFinishException;
import com.cs5500.Delivery.exception.OrderNotExistException;
import com.cs5500.Delivery.exception.OrderNotFinishedException;
import com.cs5500.Delivery.exception.PasswordNotMatchException;
import com.cs5500.Delivery.exception.UserAlreadyExistException;
import com.cs5500.Delivery.exception.UserNotExistException;
import com.cs5500.Delivery.model.Driver;
import com.cs5500.Delivery.model.Order;
import com.cs5500.Delivery.service.DriverServiceImpl;
import com.cs5500.Delivery.service.OrderServiceImpl;
...
public class DriverController {
  ...
  public Driver getDriverById(@PathVariable("id") String id)
    ...
    return driverService.getUser(id)
        .orElseThrow(() -> new UserNotExistException("O usuário não existe"));
  }
  ...
  public Driver loginDriver(@RequestBody String jsonUser)
    ...
    if (driver.isEmpty()) {
      throw new UserNotExistException("O usuário não existe");
    }
  ...
  public List<Order> getPendingOrders(@PathVariable("id") String id)
    ...
    if (orderService.driverGetActiveOrder(id) != null) {
      System.out.println("O motorista já tem um pedido ativo");
      return null;
    }
  ...
  public int acceptOrder(@RequestBody String jsonOrder)
    ...
    if (res == -1) {
      throw new OrderNotExistException("O pedido não existe");
    }
    if (res == 0) {
      throw new OrderAlreadyDeliverException("Peça no carrinho ou já no delivery");
    }
    return res;
  }
  ...
  public int finishOrder(@RequestBody String jsonOrder)
    ...
    if (res == 0) {
      throw new OrderAlreadyFinishException("Pedido já finalizado");
    }
    return res;
  }
